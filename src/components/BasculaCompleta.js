...
function TableComponent() {
    ...
    const columns = () => ([
        ...
        {
            title: 'Observaciones transportista',
            dataIndex: 'observacionesTrans',
            key: 'observacionesTrans',
        },
        {
        ...
        },
        {
            ...
            dataIndex: 'observacionesDesc',
            key: 'observacionesDesc',
        },
        {
            title: 'Observaciones de laboratorio',
            dataIndex: 'observacionesLab',
            key: 'observacionesLab',
        },
        {
            title: 'Estado',
            dataIndex: 'estado',
    ...
    return (
        ...
        <table className='table'>
          <tbody>
            ...
            <tr>
              <th>Observaciones transportista</th>
              <td>{selectedRowDetails?.observacionesTrans || 'Ninguna'}</td>
            </tr>
            <tr>
            ...
            <tr>
              <th>Observaciones de descarga y CTR</th>
